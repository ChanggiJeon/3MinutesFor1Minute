...
-- 테이블 데이터 myproject.auth_permission:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 myproject.django_content_type:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 myproject.django_migrations:~0 rows (대략적) 내보내기
...
myprojectaccounts_useraccounts_user