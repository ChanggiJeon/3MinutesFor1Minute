# Generated by Django 4.0.3 on 2022-03-26 16:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_file', models.FileField(blank=True, upload_to='minute/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('record_file', models.FileField(blank=True, upload_to='record/')),
                ('reference_file', models.FileField(blank=True, upload_to='speech/')),
                ('minute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='minutes.minute')),
